...
type FileCardType = {
	...
	heightClass: string;
	onView: (val: string | null) => void;
};

const FileView: FC<FileCardType> = ({ file, heightClass, onView }) => {
	return (
		<>
			<div className="file-view rounded-md overflow-hidden relative group border border-primary-gray border-opacity-10">
				...
				<div className="absolute bg-black-light bg-opacity-60 w-full h-full top-0 left-0 opacity-0 duration-150 group-hover:opacity-100 flex-center">
					<div>
						<Button
