...
const BreakEvenFields: FC<FormProps> = ({ form }) => {
	...
	return (
		<Accordion type="single" collapsible className="space-y-2">
			<AccordionItem value="break-even-fields" className="border-b-0">
...
export default BreakEvenFields;
