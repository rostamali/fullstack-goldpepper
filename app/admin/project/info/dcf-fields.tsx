...
const DcfFields: FC<FormProps> = ({ form }) => {
	...
	return (
		<Accordion type="single" collapsible className="space-y-2">
			<AccordionItem value="dcf-methods" className="border-b-0">
