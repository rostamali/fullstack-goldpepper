...
const ProfitEquityFields: FC<FormProps> = ({ form }) => {
	...
	return (
		<div className="profit-equity-fields">
			<Accordion type="single" collapsible className="space-y-2">
				<AccordionItem
					value="profit-equity-fields"
							...
							{fields.length > 0 &&
								fields.map((item, index) => (
									...
									>
										...
										<FormField
											control={form.control}
											name={`profitEquity.${index}.profit`}
											render={({ field }) => (
												<FormItem>
													<FormLabel className="field-label-sm">
														Profit
										...
										<FormField
											control={form.control}
											name={`profitEquity.${index}.equity`}
											render={({ field }) => (
												<FormItem>
													<FormLabel className="field-label-sm">
														Equity
...
export default ProfitEquityFields;
