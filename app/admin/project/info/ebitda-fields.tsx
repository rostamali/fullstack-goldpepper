...
const EbitdaFields: FC<FormProps> = ({ form }) => {
	...
	return (
		<Accordion type="single" collapsible className="space-y-2">
			<AccordionItem value="ebitda-methods" className="border-b-0">
