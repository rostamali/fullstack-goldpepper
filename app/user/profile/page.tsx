...
export const metadata = {
	title: 'Your Investment Profile | My Profile',
	description: `Navigate your investment journey with ease. Your profile is the key to managing success – track investments, view performance, and customize your strategy for financial growth.`,
};
