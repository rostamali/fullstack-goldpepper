	...
	return (
		<div className="project-list dashboard-col-space">
				...
				<Table className="shadow-light-100">
					<TableHeader className="[&_tr]:border-b-0">
						<TableRow className="border-b-0">
							...
							<TableHead className="p-0">
								<div className="table-head-data">Capex</div>
							</TableHead>
							<TableHead className="p-0">
								<div className="table-head-data">ROI</div>
							</TableHead>
							<TableHead className="p-0">
								<div className="table-head-data">Cost</div>
							</TableHead>
							<TableHead className="p-0">
								<div className="table-head-data">Revenue</div>
							</TableHead>
							<TableHead className="p-0">
					...
					<TableBody className="border-t-0">
						{list.map((item, index) => (
							...
							>
								...
								<TableCell className="p-0">
									<div className="table-cell-data min-h-[80px] text-center">
										{item.capex}
									</div>
								</TableCell>
								<TableCell className="p-0">
								...
								<TableCell className="p-0">
									<div className="table-cell-end min-h-[80px]">
										<ProjectAction id={item.projectId} />
									</div>
								</TableCell>
							</TableRow>
						))}
			...
			<div className="flex items-center justify-between max-sm:flex-col max-sm:items-start gap-[15px]">
				<div className="text-base-1 opacity-0">0 row(s) selected.</div>
				<Pagination
					pages={pages}
					containerClass={''}
					prevBtnClass={''}
