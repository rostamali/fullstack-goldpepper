...
import { formUrlQuery, removeKeysFromQuery } from './search-query';
...
const LocalSearch: React.FC<LocalSearchProps> = ({
	...
	return (
		<div
			className={`font-poppins rounded-md flex items-center focus-within:ring-2 focus-within:ring-offset-[3px] focus-within:ring-primary-gold focus-within:ring-opacity-60 ${
